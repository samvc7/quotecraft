...
export const DescriptionCollapsible = () => {
  return (
    <Collapsible className="max-w-[1000px] flex flex-col justify-center gap-4">
      <CollapsibleTrigger>
        <h2 className="text-lg text-center text-slate-500 dark:text-slate-400">
          A simple and uplifting app designed to inspire and motivate you.{" "}
        </h2>
      </CollapsibleTrigger>

      <CollapsibleContent className="flex flex-col">
        <Separator className="w-[500px] mb-4 h-0.5 self-center" />
